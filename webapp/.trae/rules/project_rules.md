...
2. [.trae/rules/project_rules.md](../../.trae/rules/project_rules.md) — 根规则锚点（Part A Git 工作流 / Part B AI 行为 / Part C Skill 管理 / Part D 维护指南 / Part E MCP 规范 / Part F Agent 选用 / Part G Token 优化）
